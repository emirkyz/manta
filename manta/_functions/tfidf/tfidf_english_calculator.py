...
def tf_idf_english(veri, tokenizer, use_bm25=False, k1=1.2, b=0.75, use_pivoted_norm=True, slope=0.2) -> scipy.sparse.csr.csr_matrix:
    """
    ...
    Args:
        veri (list): A list of numerical representations of documents (from tokenizer.encode().ids).
        tokenizer: A trained tokenizer object with get_vocab_size() method.
    ...
    Returns:
        scipy.sparse.csr_matrix: Sparse TF-IDF or BM25 matrix with shape (N, vocab_size) where:
    ...
    try:
        ...
        gercek_gerekli_alan = dokuman_sayisi * kelime_sayisi * 3 * 8 / 1024 / 1024 / 1024
        ...
        max_optimal_topic_num = counnt_of_nonzero // (dokuman_sayisi + kelime_sayisi)
        print("max_optimal_topic_num : ", max_optimal_topic_num)
        percentage_of_nonzero = counnt_of_nonzero / (dokuman_sayisi * kelime_sayisi)
